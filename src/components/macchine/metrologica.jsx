...
export const Metrologica = () => {
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="grid gap-10 lg:grid-cols-2">
        <div className="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
          <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
            <PiPencilRulerDuotone className="text-orange-accent-400 w-9 h-9" />
          </div>
          <div className="max-w-xl mb-6">
            ...
            <p className="text-base text-gray-700 md:text-lg">
              Inaugurata nel 2017, la sala di misura climatizzata è dotata di
              macchina 3D Hexagon di ultima generazione.
            </p>
          </div>
          <div>
            <a
              href="/macchine/metrologica"
              aria-label=""
