    ...
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-orange-accent-400">2.6 MLN</h6>
        ...
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-orange-accent-400">2.3 MLN</h6>
        ...
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-orange-accent-400">3177</h6>
          <p className="mb-2 font-bold text-md">
        ...
        <div className="text-center">
          ...
          <h6 className="text-4xl font-bold text-orange-accent-400">245K</h6>
          <p className="mb-2 font-bold text-md">
