      ...
      <div class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
        <div class="relative flex items-center justify-between">
          <div class="flex items-center">
            <a
              href="/"
              aria-label="Bipres S.p.A"
              title="Bipres S.p.A"
              class="inline-flex items-center mr-8"
            >
              <img src={logoWhite} alt="" height="200px" />
            </a>
            <ul class="flex items-center hidden space-x-8 lg:flex">
              <li>
                <a
                  ...
                  aria-label="Settori"
                  title="Settori"
                  class="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:text-orange-accent-400"
                >
                  Settori
                </a>
              </li>
          ...
          <ul class="flex items-center hidden space-x-8 lg:flex">
            <li>
              <a
                href="/"
                class="inline-flex items-center justify-center h-12 px-6 font-medium tracking-wide text-white transition duration-200 rounded shadow-md bg-orange-accent-400 hover:bg-orange-accent-700 focus:shadow-outline focus:outline-none"
                aria-label="Login"
                title="Login"
              >
                Login
                ...
                <div class="p-5 bg-white border rounded shadow-sm">
                  <div class="flex items-center justify-between mb-4">
                    <div>
                      ...
                      >
                        <img src={logoBlack} alt="" height="100px" />
                      </a>
                    </div>
                    <div>
                      <button
